...
/*   Updated: 2025/03/17 00:14:40 by kipouliq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_ADC(void)
{
    ...
    // ADMUX |= (1 << ADLAR); // ADLAR clear = 10 bits conversion
...
int get_conversion(void)
{
    ...
    return (ADCL | (ADCH << 8)); // reading low register FIRST (!) and then the high register
}
