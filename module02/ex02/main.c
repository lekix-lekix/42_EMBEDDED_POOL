...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/07 12:41:48 by kipouliq          #+#    #+#             */
/*   Updated: 2025/03/07 13:13:31 by kipouliq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void uartinit(void)
{
    ...
    UCSR0B = (1 << TXEN0 | 1 << RXEN0); // setting the "Transmit Enabled" and "Receive Enabled" bits
}
...
int main (void)
{
    ...
    while (1)
    {
        if (UCSR0A & (1 << RXC0)) // communication detected
            uart_tx(uart_rx());
    }
}