...
/*   Updated: 2025/03/17 16:05:42 by kipouliq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main ()
{
    ...
    while (1)
    {
        ...
        expander_set_register(CONFIG_REG_0, state_2);
        expander_set_register(OUTPUT_REG_0, state_2);
        expander_set_register(OUTPUT_REG_1, SEG_4);
